import svgPaths from "./svg-p6yqf1s4k7";
import imgEllipse624 from "./e83d2d2338d69fe2def34b9e7b7d8bdbb262acac.png";
import { imgControl } from "./svg-svpj7";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-[1320px]">
      <Frame3 />
      <Frame1 />
      <Subscribe />
    </div>
...
function Menu1() {
  return (
    <div className="content-stretch flex gap-[24px] items-center justify-center relative shrink-0" data-name="Menu">
      <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[16px] text-center tracking-[0.1px] whitespace-nowrap">Inicio</p>
...
function HeaderMenu1() {
  return (
    <div className="absolute bg-[#cbdcef] content-stretch flex inset-0 items-center justify-between overflow-clip pl-[48px] py-[48px]" data-name="Header Menu">
      <div className="h-[64.513px] overflow-clip relative shrink-0 w-[195px]" data-name="Logo Baby Bear">
        <Group3 />
        <Group4 />
        <Group5 />
      </div>
...
function HeaderMenu() {
  return (
    <div className="-translate-x-1/2 absolute h-[120px] left-1/2 top-0 w-[1512px]" data-name="Header Menu">
      <HeaderMenu1 />
      <div className="absolute bottom-0 left-0 right-0 top-full">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1512 2">
...
function ContactInfo() {
  return (
    <div className="absolute bg-[rgba(224,210,183,0.2)] content-start flex flex-wrap gap-y-[48px] items-start left-[209px] overflow-clip p-[24px] rounded-[20px] top-[405.87px] w-[1119px]" data-name="Contact  info">
      <Frame16 />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_74.32%_80.28%_0] items-start">
      <Frame10 />
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] inset-[36.62%_0_0_0] items-end">
      <FuncionalidadParaSeguimiento />
      <div className="bg-[#f6f6f6] h-px relative shrink-0 w-full" data-name="Division" />
      <Etiquetas />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] relative size-full">
          <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[329px]">
            <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Nombre del usuario</p>
            <Group6 />
          </div>
          <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Secciones terminadas</p>
          <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Tiempo dedicado</p>
          <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Cursos inscritos</p>
          <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Cursos completados</p>
          <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#506685] text-[12px] tracking-[-0.25px] whitespace-nowrap">Certificados generados</p>
        </div>
      </div>
    </div>
  );
...
export default function PerfilAdminInscritas() {
  return (
    <div className="bg-white relative size-full" data-name="Perfil admin (Inscritas)">
      <div className="absolute bg-[#c7c9cd] h-[146.031px] left-0 opacity-20 top-[120px] w-[1512px]" />
      <div className="-translate-x-1/2 absolute bg-[#e0d2b7] bottom-[0.13px] content-stretch flex flex-col gap-[24px] items-center left-1/2 overflow-clip px-[93px] py-[48px] w-[1512px]" data-name="Footer">
        <Frame2 />
        <Legales />
      </div>
      <HeaderMenu />
      <ContactInfo />
      <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(50%+0.5px)] overflow-clip p-[24px] rounded-[20px] top-[758.87px] w-[1119px]" data-name="Inscrritas">
        <div className="h-[142px] relative shrink-0 w-[1071px]" data-name="Top section">
          <Frame17 />
          <Frame33 />
        </div>
        <Frame6 />
      ...
      <div className="absolute left-[221.21px] size-[180px] top-[177.87px]">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="180" src={imgEllipse624} width="180" />
      </div>
      <div className="absolute left-[361.21px] size-[40px] top-[317.87px]">
        <div className="absolute inset-[0_-10%_-20%_-10%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
            <g filter="url(#filter0_d_3_3701)" id="Ellipse 625">
              <circle cx="24" cy="20" fill="var(--fill-0, white)" r="20" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="48" id="filter0_d_3_3701" width="48" x="0" y="0">
                ...
                <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_3_3701" />
                <feBlend in="SourceGraphic" in2="effect1_dropShadow_3_3701" mode="normal" result="shape" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute inset-[16.73%_74.07%_82.25%_24.6%]" data-name="PencilSimple">
        <div className="absolute inset-[10.67%_10.67%_12.5%_12.5%]" data-name="Vector">
